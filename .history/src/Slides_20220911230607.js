        ...
        <Col xs={9} className="footer">
          ...
          >
            <span className="scroll-text">
              <span className="nd-part">"SOCAT's</span>
              various services offered as part of Site Management includes{" "}
              <span className="nd-part">:</span>
              'Catering' 'Housekeeping' 'Cleaning' 'Laundry' 'Pest Control'
              'Preventive Maintenance' 'Manpower supply' 'Gardening &
              Landscaping'
              <span className="nd-part">
                / "The above services cover all different segments in the
                country including: 'Oil & Gas' 'Hospitals ' 'Schools ' 'Defense
