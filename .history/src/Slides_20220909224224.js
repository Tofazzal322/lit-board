...
const Slides = () => {
  return (
    ...
    <section className="ms-3">
      <Row className="pt-5 ms-1 mt-2 text-center profile">
        <h2>COMPANY PROFILE</h2>
      </Row>
      <Row className="responsive ">
        <iframe
          src="https://docs.google.com/presentation/d/e/2PACX-1vRGnfPC-_9O8k6WuHld1NOM4cGwnjeLO8xpZioC2Dxh-VXSyFfqC2NM6FnEd_Vjxw/embed?showinfo=0&controls=0start=true&loop=true&delayms=5000"
          width="620"
          height="420"
          allowfullscreen="true"
          transparent="100"
