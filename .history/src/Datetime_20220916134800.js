  ...
  return (
    <div>
      ...
      <Container >
        ...
        <Row>
          <Col md={6} xs={12} >
<img className="h-1 mt-2 " src="https://s3.amazonaws.com/sdxuk-uploads/kKKSsf0g0336ia2hnASpPSdmm85Jbq7S5dh827rb7kRtw1llSdwra0okRsd.jpg" alt="" />
          </Col>
          <Col md={6} xs={12}>
            <img className="h-12 mt-3" src="https://s32891.pcdn.co/wp-content/uploads/2017/12/zeromindset.png" alt="" />
          </Col>
