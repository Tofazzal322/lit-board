    ...
    <div>
      ...
      <Container >
        <Row className="row-decoration">
          <Col xs={6} className="">
            <h5 className="title-decoration">TODAY'S DATE</h5>
          </Col>
        ...
        <Row className="mt-4 row-decoration">
          <Col xs={6} className="">
            <div>
              <h5 className="best text-warning title-decoration">DAYS WITHOUT LTI</h5>
            </div>
          </Col>
          <Col xs={6} className="">
            <div>
        ...
        <Row className="mt-4 row-decoration">
          <Col xs={6} className="">
            <div>
              <h5 className="text-color title-decoration pt-3 mt-3">DATE LAST ACCIDENT</h5>
            </div>
          </Col>
          <Col xs={6} className="">
            <div>
        ...
        <Row className="mt-4 row-decoration">
          <Col xs={6} className="">
            <div>
              <h5 className="text-color title-decoration">DAYS PREVIOUS BEST </h5>
            </div>
          </Col>
          <Col xs={6} className="">
            <div>
