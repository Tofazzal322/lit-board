  ...
  return (
    <div>
      ...
      <Container >
        ...
        <Row>
          <Col xs={6}>
<img className=" pt-4 mt-4" src="https://s3.amazonaws.com/sdxuk-uploads/kKKSsf0g0336ia2hnASpPSdmm85Jbq7S5dh827rb7kRtw1llSdwra0okRsd.jpg" alt="" />
          </Col>
          <Col xs={6} >
<img className="w-100 h-100 pt-4 mt-2" src="https://www.sodexojobs.co.uk/application/assets/20/images/logo.png" alt="" />
          </Col>
        </Row>
      </Container>
    </div>
