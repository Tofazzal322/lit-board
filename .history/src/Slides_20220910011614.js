    ...
    <section className="ms-3">
      ...
      <Row className="  ms-1  mt-2">
        <Col xs={3} className="latest-news">
          <div>
          <h5 className="latest-news-text"> <small className="">Latest</small> <small className="news">News</small></h5>
        </div>
        </Col>
        <Col xs={9} className="footer">
          ...
          gradientWidth="200"
        >
         <span>I can be a React component," Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore nobis nemo animi dicta quasi eum laboriosam, laudantium reprehenderit. Maxime quisquam est similique. Accusamus perferendis fugit reiciendis quam veritatis officia explicabo? </span>
        </Marquee>
        </Col>
