...
const Slides = () => {
    ...
    const docs = [
    { uri: "https://docs.google.com/presentation/d/e/2PACX-1vRGnfPC-_9O8k6WuHld1NOM4cGwnjeLO8xpZioC2Dxh-VXSyFfqC2NM6FnEd_Vjxw/embed?showinfo=0&controls=0&start=true&loop=true&delayms=5000&slide=id.p2" },
    ...
    <section className="ms-3">
      ...
      <Row className="responsive ">
        <div className="ms-1">
          ...
          <DocViewer documents={docs} pluginRenderers={PPTRender}/>;
      ...
      <Row className="  ms-1  mt-2">
        ...
        >
            <span className="scroll-text">I can be a React component," Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore nobis nemo animi dicta quasi eum laboriosam,
              ...
              <span className="nd-part"> laudantium reprehenderit. Maxime quisquam est similique. Accusamus perferendis fugit reiciendis quam veritatis officia explicabo?</span> </span>
        </Marquee>
        </Col>
