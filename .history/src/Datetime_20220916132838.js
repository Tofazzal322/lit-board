  ...
  return (
    <div>
      ...
      <Container >
        ...
        <Row>
          <Col md={6} xs={12} >
<img className=" pt-5 h-50 mt-5" src="https://s3.amazonaws.com/sdxuk-uploads/kKKSsf0g0336ia2hnASpPSdmm85Jbq7S5dh827rb7kRtw1llSdwra0okRsd.jpg" alt="" />
          </Col>
          <Col md={6} xs={12} className="mt-5">
<img className="sodexo-logo w-100 h-50 pt-5 mt-5" src="https://www.sodexojobs.co.uk/application/assets/20/images/logo.png" alt="" />
          </Col>
        </Row>
      </Container>
    </div>
