        ...
        <Col xs={9} className="footer">
          ...
          >
            <span className="scroll-text">
              ...
              includes : <span className="nd-part"></span>
               <span className="nd-part"></span> Catering | Housekeeping | Cleaning | Laundry | Pest Control | Preventive Maintenance | Manpower supply | Gardening &
              Landscaping' |
