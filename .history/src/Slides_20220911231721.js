        ...
        <Col xs={9} className="footer">
          ...
          >
            <span className="scroll-text">
              ...
              includes :
               <span className="nd-part">|</span> Catering  <span className="nd-part">|</span> Housekeeping  <span className="nd-part">|</span> Cleaning  <span className="nd-part">|</span> Laundry  <span className="nd-part"></span> Pest Control | Preventive Maintenance | Manpower supply | Gardening &
              Landscaping' |
