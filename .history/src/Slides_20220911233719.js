          ...
          >
            <span className="scroll-text">
              ...
              <span className="nd-part2">
                ...
                country including : <span className="nd-part">|</span> Oil & Gas  <span className="nd-part">|</span> Hospitals <span className="nd-part">|</span> Schools <span className="nd-part">|</span> Defense  <span className="nd-part">|</span> Business Institutions "
              </span>
            </span>
          </Marquee>
        </Col>
