        ...
        <Col xs={9} className="footer">
          ...
          >
            <span className="scroll-text">
               ...
               various services offered as part of Site Management includes  <span className="nd-part">
               : 
              </span>
              'Catering' 
              'Housekeeping' 
              ...
              "The above services cover all different segments in the country including:
              Oil & Gas
              'Hospitals '
              'Schools '
              'Defense '
